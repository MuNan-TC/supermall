<template>
  <div class="goods-info" v-if="Object.keys(goodsInfo) != 0">
    <div class="info-text-wrap">
			<div class="text-top-style"></div>
			<div class="desc info-text-desc">{{goodsInfo.desc}}</div>
			<div class="text-bot-style"></div>
		</div>
		<div class="img-list-wrap" v-for="(item, index) in goodsInfo.detailImage" :key="index">
